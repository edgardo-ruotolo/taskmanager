...
namespace TaskManager.Api.Migrations
{
    ...
    [Migration("20260518063014_AddImporterWorklogsMagicLink")]
    partial class AddImporterWorklogsMagicLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManager.Api.Modules.Auth.Entities.ApiActivityLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaskManager.Api.Modules.Auth.Entities.ApiToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaskManager.Api.Modules.Favorites.Entities.Favorite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaskManager.Api.Modules.Integrations.Entities.GitHubRepository", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaskManager.Api.Modules.Integrations.Entities.WorkspaceIntegration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("WorkspaceIntegrations");
                });
            ...
            modelBuilder.Entity("TaskManager.Api.Modules.Webhooks.Entities.WebhookLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaskManager.Api.Modules.Auth.Entities.ApiActivityLog", b =>
                {
                    b.HasOne("TaskManager.Api.Modules.Auth.Entities.ApiToken", "ApiToken")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManager.Api.Modules.Webhooks.Entities.WebhookLog", b =>
                {
                    b.HasOne("TaskManager.Api.Modules.Webhooks.Entities.Webhook", "Webhook")
                        .WithMany("Logs")
