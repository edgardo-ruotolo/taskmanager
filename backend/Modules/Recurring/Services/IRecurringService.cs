...
public interface IRecurringService
{
    ...
    Task<PagedResult<RecurringTemplateDto>> ListAsync(
    ...
    Task<RecurringTemplateDto> DuplicateAsync(string workspaceSlug, Guid templateId, Guid userId, CancellationToken ct = default);
