...
public class RequireProjectMemberAttribute : Attribute, IAsyncActionFilter
{
    public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
    {
        ...
        var projectContext = context.HttpContext.RequestServices.GetRequiredService<ICurrentProjectContext>();
