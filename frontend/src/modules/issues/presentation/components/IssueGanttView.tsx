                    ...
                    {issues.length === 0 ? (
                        ...
                        issues.map((issue) => (
                            <button
                                ...
                                className="w-full h-12 flex items-center border-b border-[var(--neutral-300)] last:border-b-0 hover:bg-[var(--neutral-100)] transition-colors text-left"
                            >
                                {/* Issue ID + title */}
                                <div className="flex items-center gap-2 px-3 flex-1 min-w-0">
                                    {/* Circular SVG state indicator */}
                                    <StatePip
                                    ...
                                    >
                                        ...
                                        {!bar.hasNoDate && !bar.isDiamond && bar.widthPct > 0 && (
                                            <button
                                                ...
                                                onClick={() => onRowClick(issue.id)}
                                                title={issue.title}
                                                className="absolute top-1/2 -translate-y-1/2 h-[6px] rounded-full opacity-80 hover:opacity-100 transition-opacity cursor-pointer"
                                                style={{
                                                    left: `${bar.leftPct}%`,
                                                    width: `${bar.widthPct}%`,
                                                    minWidth: '8px',
