...
function ProjectCard({ project, accentColor, onClick }: ProjectCardProps): React.ReactElement {
        ...
        <div className="h-full overflow-y-auto">
            <div className="mx-auto max-w-5xl px-10 py-8">
                ...
                <div className="flex items-start justify-between mb-8">
                    <div>
                        <Eyebrow>Tus proyectos · {isLoading ? '…' : `${projects.length} activos`}</Eyebrow>
                        ...
                        <p className="mt-2 text-[14.5px] text-[var(--neutral-600)] max-w-[600px]">
                            Cada project es un proyecto con su propia jerarquía de issues, ciclos y módulos.
                        </p>
                    </div>
                ...
                {!isLoading && projects.length === 0 && (
                    <div className="flex flex-col items-center justify-center py-24 text-center">
                        ...
                        <h2 className="text-[18px] font-medium text-[var(--neutral-1200)] mb-2">No hay proyectos aún</h2>
                        <p className="text-[13px] text-[var(--neutral-600)] mb-6">
                            Crea la primera proyecto de este workspace
                        </p>
                        <CreateProjectDialog
                            workspaceSlug={workspaceSlug}
                            trigger={
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {projects.map((project, index) => (
                            <ProjectCard
                                ...
                                onClick={() => void navigate(`/${workspaceSlug}/projects/${project.id}/issues`)}
                            />
                        ))}
                    </div>
                )}
