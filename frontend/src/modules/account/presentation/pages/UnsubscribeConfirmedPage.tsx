...
export function UnsubscribeConfirmedPage(): React.ReactElement {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center px-4" style={{ background: 'var(--canvas)' }}>
            <div className="w-full max-w-md flex flex-col items-center gap-6 text-center">
                ...
                >
                    <CheckCircle size={28} style={{ color: 'var(--green-700)' }} aria-hidden="true" />
                </div>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-[13.5px] leading-relaxed" style={{ color: 'var(--neutral-900)' }}>
                        Te has dado de baja de los correos de TaskManager. Podés reactivarlos en cualquier momento desde tu configuración.
                    </p>
                </div>
