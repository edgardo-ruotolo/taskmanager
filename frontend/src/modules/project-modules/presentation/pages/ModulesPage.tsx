...
const STATUS_CHIP: Record<ProjectModule['status'], string> = {
...
const PROGRESS_PCT: Record<ProjectModule['status'], number> = {
    Backlog: 0,
    InProgress: 40,
    Paused: 20,
    Completed: 100,
...
export const ModulesPage = (): React.ReactElement => {
    ...
    const { mutate: deleteModule, isPending: isDeleting } = useDeleteModule(workspaceSlug, companyId);
